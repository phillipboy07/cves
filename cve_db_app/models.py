...
class Vulnerability(models.Model):
    ...
    cvss_base_score = models.DecimalField(blank=True, max_digits=5, decimal_places=2)
    cvss_temporal_score = models.DecimalField(blank=True, max_digits=5, decimal_places=2)
